 ...
 */
define( 'FPORTFOLIO_MIN_PHP_VERSION', '5.6' );
...
function fportfolio_load_scripts() {
	...
	wp_enqueue_style( 'fportfolio-fonts', fportfolio_fonts_url(), array(), null );
...
/**
 *	Load google font url used in the fPortfolio theme
 */
function fportfolio_fonts_url() {
    ...
    */
    $cantarell = _x( 'on', 'Varela Round font: on or off', 'fportfolio' );
...
function fportfolio_widgets_init() {
	...
	register_sidebar( array (
						...
						'id'		 	 =>	 'portfolio-homepage-below-menu-area',
